...
popt_stop, pcov_stop = curve_fit(myCurve, ALL_TEMPS_at_stop, ALL_STOPS_at_dT, maxfev = 200000, p0=(4,4,2))
popt_walk, pcov_walk = curve_fit(myCurve, ALL_TEMPS_at_walk, ALL_WALKS_at_dT, maxfev = 200000, p0=(1,1,1))
...
subfigure_stop.plot(x, myCurve(x, *popt_stop), linewidth=3, color='red', linestyle='dotted')#, linewidth=1)
subfigure_walk.plot(x, myCurve(x, *popt_walk), linewidth=3, color='blue', linestyle='dotted')#, linewidth=1)
...
subfigure_stop.set_ylabel("stop duration " r'$[s]$')
subfigure_walk.set_xlabel(r'$\Delta T \,[°C]$')
subfigure_walk.set_ylabel("walk duration " r'$[s]$')
#plt.xscale('log')
#plt.yscale('log')
plt.show()
