...
_BIG_D_IBs = ["BT06A-2", "BT08A-4", "BT14A-2", "BT11A-4"]
_BIG_D_RWs = ["BT06B-1", "BT07A-3", "BT13A-2", "BT15A-1"]
_BIG_D_WFs = ["BT04B-3", "BT08B-1", "BT13B-3", "BT17B-4"]
_BIG_D_GFs = ["BT08B-4", "BT09A-2", "BT12B-2", "BT01A-3"]
